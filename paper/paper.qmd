...
cleaned_shelter_data <- read.csv("/Users/liz/Downloads/starter_folder-main/data/analysis_data/analysis_data.csv")
...
total_population_data <- subset(cleaned_shelter_data, group == "All Population")
